...
<body class="min-h-screen bg-white font-sans text-black antialiased">
    <div
        ...
        <div class="relative hidden h-full flex-col justify-between overflow-hidden bg-black p-10 text-white lg:flex">
            <img src="https://images.pexels.com/photos/34691207/pexels-photo-34691207.jpeg?auto=compress&cs=tinysrgb&w=1200&h=1600&fit=crop"
                alt="" aria-hidden="true" class="absolute inset-0 size-full object-cover opacity-60">
            ...
            <a href="{{ route('home') }}" class="relative z-20 flex items-center" wire:navigate>
                <img src="{{ asset('images/logo-white.png') }}" alt="Ready-To-Wear by Amena"
                    class="h-10 w-auto object-contain">
            </a>

            <div class="relative z-20">
                <p class="rtw-label mb-3 text-white/70">Ready-To-Wear by Amena</p>
                <p class="font-serif text-2xl leading-snug">Precise tailoring, considered fabrics &mdash; a wardrobe
                    built to last beyond the season.</p>
            </div>
        </div>
